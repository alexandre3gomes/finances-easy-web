...
export class SavingsEffects {
    ...
    createSavings = this.actions.pipe(
        ...
        map((action: SavingsActions.CreateSavings) => action.payload),
        switchMap((savings: Savings) => this.http.post<Savings>(this.savingsEndPoint, savings).pipe(
    ...
    updateSavings = this.actions.pipe(
        ...
        map((action: SavingsActions.UpdateSavings) => action.payload),
        switchMap((savings: Savings) => this.http.post<Savings>(this.savingsEndPoint.concat('/update'), savings).pipe(
                mergeMap((sav: Savings) => [
                        {
    ...
    deleteSavings = this.actions.pipe(
        ...
        map((action: SavingsActions.DeleteSavings) => action.payload),
        switchMap((id: number) => this.http.delete(this.savingsEndPoint.concat('/').concat(id.toString())).pipe(
                mergeMap(() => [
                        {
    ...
    listSavingss = this.actions.pipe(
        ...
        switchMap((action: SavingsActions.ListSavings) => this.http.get(this.savingsEndPoint, {
